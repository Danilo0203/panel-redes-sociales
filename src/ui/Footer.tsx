export const Footer = () => {
  return (
    <footer className="flex flex-wrap items-center justify-center gap-2 py-2 text-center md:gap-5">
      <p className="text-[0.7rem] dark:text-white sm:text-xl lg:text-lg">
        Desafio por{" "}
        <b>
          <a
            href="https://www.frontendmentor.io/profile/Danilo0203"
            target="_blank"
          >
            FrontMentor
          </a>
      ...
      <div className="flex gap-4">
        <a
          href="https://github.com/Danilo0203/calculador-edad-app"
          target="_blank"
        >
          <img
